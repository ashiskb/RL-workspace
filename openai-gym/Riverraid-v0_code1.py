#!/Users/ashis/venv-directory/venv-p310-RL-workspace/bin/python3.10
...
#Or, simply run from the python interpreter
...
env = gym.make("ALE/Riverraid-v5", render_mode=render_mode)
...
with imageio.get_writer('./video/ALE_Riverraid-v5-random.gif', mode='I') as writer:
